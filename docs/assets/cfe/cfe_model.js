...
cfeParams.addEventListener("load", (ev) => {
  ...
  SetUp(9,1,.55,[.08,.08,.07]); // flanges
  SetUp(10,0.9,.5,[.3,0,0]); // PV
  SetUp(11,0.9,.5,[0,.1,.2]); // adaptor
  SetUp(12,0.9,.5,[.48,.05,.4]); // stators
  SetUp(13,0.9,.5,[0,.15,.08]); // end cap
  SetUp(14,0.9,.5,[.12,.12,.05]); // bearing cap
